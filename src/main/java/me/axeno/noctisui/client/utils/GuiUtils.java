...
public class GuiUtils
{
    ...
    {
        return new Color3f(
                MathUtils.lerp(start.getRed() * 255.0F, end.getRed() * 255.0F, percentage),
                MathUtils.lerp(start.getGreen() * 255.0F, end.getGreen() * 255.0F, percentage),
                MathUtils.lerp(start.getBlue() * 255.0F, end.getBlue() * 255.0F, percentage)
        );
    }
